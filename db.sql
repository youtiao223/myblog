...
--
-- Host: 120.55.94.208    Database: myblog
-- ------------------------------------------------------
...
CREATE TABLE `profiles` (
  ...
  `motto` varchar(100) DEFAULT '这家伙很懒,没有写',
  `self_introduction` varchar(200) DEFAULT '这家伙很懒,没有写',
  `qq` varchar(15) DEFAULT NULL,
  `we_chat` varchar(15) DEFAULT NULL,
  `github` varchar(60) DEFAULT NULL,
  `email` varchar(30) DEFAULT NULL,
  `back_ground_img` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2022-04-12 16:12:27
